...
| Z offset | Affects distance of nozzle to bed | [-4.0mm, 0.0mm] | -1.75 | Changing nozzle resets this. Nozzle size, line width and flow rate will affect the optimal value |
