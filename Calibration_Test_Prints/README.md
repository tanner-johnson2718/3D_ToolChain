# Calibration Tests and Test Prints
## Z_Off_Test
...
```
M851 Z0 ; Set Z off to 0.0.
G0      ; Home
M211 S0 ; Turn off end stops with M211 S0
G0 Z0   ; Move to Probe Height

;Decrment Z until its actually at 0 i.e. touching the build plate or use feeler gauge to detrmine distance if close.
G0 Z-1
G0 Z-1.5
...

M851 Z{Value} ; Store found Z offset
M211 S1       ; Turn on end stops M211 S1
...
##  Geometric Accuracy and Steps per mm Calibration
...
### Print Accel
### Travel Accel
## Cornering Test (Junction Devitaion and Advanced Movement Settings)
## FLow Calibration
...
| Print Speed | Speed while extruding | 10mm/s - 200mm/s | 80mm/s | - |
| Travel Speed | Speed while not extruding (traveling) | 50mm/s - 250mm/s | 200mm/s | - |
